...
# can be "fluence" or "fluencepro" or "none"
...
rild.libpath=/system/vendor/lib64/libril-wrapper.so
rild.libargs=-d /dev/smd0
vendor.rild.libpath=/system/vendor/lib64/libril-wrapper.so
